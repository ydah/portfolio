...
![沢山のBug fixesがされている様子](/posts/20221219/bugfixes.png)

## RuboCop とは？

![RuboCopのロゴ](/posts/20221219/rubocop-logo.png)
...
![ワークフローを手動で実行する](/posts/20221219/actions.png)

すると、以下のような Pull Request が作成されます。

![ワークフローを手動で実行する](/posts/20221219/pr.png)
